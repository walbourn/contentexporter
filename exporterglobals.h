...
#define CONTENT_EXPORTER_VSFILE_EXTENSION "cmo"
#define CONTENT_EXPORTER_VSFILE_FILTER "*." CONTENT_EXPORTER_FILE_EXTENSION
#define CONTENT_EXPORTER_VSFILE_FILTER_DESCRIPTION "Visual Studio Compiled Mesh Object File"
