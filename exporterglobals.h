...
#define CONTENT_EXPORTER_CMO_EXTENSION "cmo"
#define CONTENT_EXPORTER_CMO_FILTER "*." CONTENT_EXPORTER_CMO_EXTENSION
#define CONTENT_EXPORTER_CMO_FILTER_DESCRIPTION "Visual Studio Starter Kit Compiled Mesh Object"
