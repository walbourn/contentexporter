...
All content and source code for this package are subject to the terms of the Microsoft Public License (MS-PL). <http://opensource.org/licenses/MS-PL>.

For the latest version of the Samples Content Exporter, more detailed documentation, bug reports and feature requests, please visit the GitHub project.
